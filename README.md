![docker image](https://github.com/mcasademont9/nomad-distro-template/actions/workflows/docker-publish.yml/badge.svg)


# mcasademont9's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of mcasademont9.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/mcasademont9/nomad-distro-template.git
    ...
    ```sh
    curl-L -o nomad-distro-template.zip "https://github.com/mcasademont9/nomad-distro-template/archive/main.zip"
...
your `docker-compose.yaml` with `ghcr.io/mcasademont9/nomad-distro-template:main` for the services
...
```
docker pull ghcr.io/mcasademont9/nomad-distro-template/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/mcasademont9/nomad-distro-template/manifests/main": unauthorized`
